                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <input
                                    ...
                                    className="w-full px-3 py-2 text-white bg-gray-900 bg-opacity-50 border border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                                />
                            </div>
                        </div>
                        <div>
